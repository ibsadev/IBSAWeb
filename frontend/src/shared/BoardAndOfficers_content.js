...
export const board_members = [
   {
      ...
      name: "Valerie Taruno",
      title: "President",
      bio: "Hello! I’m a third year majoring in Biochemistry and minoring in Statistics. I drink boba and cook pasta on my free time👀. Being 95% extroverted, my energy comes from meeting and talking with people. So hit me up on my social media anytime! :)",
   ...
   },
   {
      ...
      bio: "Hi everyone! I’m a senior majoring in Business Economics. I’m always down for cafe hopping, hiking adventures and exploring new places. I love understanding people’s motivations, feelings and needs. Reach out if you need an ear or cafe recs!",
   ...
   },
   {
      ...
      bio: "Hi friends! I’m a third year Physiological Science major (the only major that deals with cadavers). I’m an ENFJ that loves reading almost everything, scenic hikes and desserts 😋. I’m on my phone 24/7, if I don’t reply I’m studying or sleeping, so feel free to text me anytime! ",
...
export const officers = [
   ...
   },
   {
      ...
      title: "Media & Public Relations Officer",
      bio: "Hi! I’m a first year Data Theory student with interests in data science and finance. Hit me up if you wanna talk about cooking, baking, music, kdramas and books! ",
